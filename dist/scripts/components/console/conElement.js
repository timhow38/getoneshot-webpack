...
//Put the above code into a function called conTerm
function conTerm() {
    let cliView;
!(function () {
    var t = {
...
//var $output = $('<div class="command output">Text</div>');
//$(".print").append($output);

//create a div with the class "command output" and append it to .print
